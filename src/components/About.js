  ...
  return (
    <div className="about-container">
      <div className="about-content">
        ...
        <h2>About Us</h2>
      <p>Welcome to Yesurise, your digital innovation partner. We specialize in providing tailored digital solutions for businesses, including website development, digital marketing, and software development.</p>
